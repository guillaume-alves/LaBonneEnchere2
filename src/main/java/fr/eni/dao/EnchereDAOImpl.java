...
public class EnchereDAOImpl implements EnchereDAO {
    ...
    private static final String SQL_SELECT_ALL_ARTICLES_BY_NAME_SEARCH	= "SELECT * FROM Articles INNER JOIN Users ON Articles.article_user_id = Users.user_id WHERE article_name LIKE ?";
    ...
    private static final String SQL_SELECT_SALE_ARTICLES       			= "SELECT * FROM Articles INNER JOIN Users ON Articles.article_user_id = Users.user_id WHERE article_user_id=?";
    private static final String SQL_SELECT_PURCHASED_ARTICLES		    = "SELECT * FROM Articles INNER JOIN Bids ON Articles.article_id = Bids.bid_article_id INNER JOIN Users On Users.user_id = Bids.bid_user_id WHERE bid_user_id=?";
	...
	// Interface EnchereDAO implementation
	@Override
	public List<Article> getListArticlesByArticleNameSearch(String articleNameSearch) throws DAOException {
		Connection conn = null;
        PreparedStatement preparedStatement = null;
        ResultSet resultSet = null;
        List<Article> list_articles = new ArrayList<Article>();
        ...
        try {
            // Getting connection from Factory
            conn = daoFactory.getConnection();
            preparedStatement = initPreparedStatement(conn, SQL_SELECT_ALL_ARTICLES_BY_NAME_SEARCH, articleNameSearch);
            resultSet = preparedStatement.executeQuery();
            // Request reading
            while (resultSet.next()) {
                article = fetchArticle(resultSet);
	...
	@Override
    public List<Article> getListSaleArticles(Integer userId) throws DAOException {
		Connection conn = null;
        PreparedStatement preparedStatement = null;
        ...
        try {
            // Getting connection from Factory
            conn = daoFactory.getConnection();
            preparedStatement = initPreparedStatement(conn, SQL_SELECT_SALE_ARTICLES, userId);
            resultSet = preparedStatement.executeQuery();
            // Request reading
            while (resultSet.next()) {
                article = fetchArticle(resultSet);
	...
	@Override
    public List<Article> getListPurchasedArticles(Integer userId) throws DAOException {
        Connection conn = null;
        PreparedStatement preparedStatement = null;
        ResultSet resultSet = null;
        List<Article> list_articles = new ArrayList<Article>();
        ...
        try {
            // Getting connection from Factory
            conn = daoFactory.getConnection();
            preparedStatement = initPreparedStatement(conn, SQL_SELECT_PURCHASED_ARTICLES, userId);
            resultSet = preparedStatement.executeQuery();
            // Request reading
            while (resultSet.next()) {
                article = fetchArticle(resultSet);
